...
public class Vorstellung
{
     ...
     * @require datum != null
     * @require preis.getEuroCent(preis) >= 0
     * 
            ...
            Uhrzeit endzeit, Datum datum, Geldbetrag preis)
    {
        ...
        assert preis.getEuroCent(preis) >= 0 : "Vorbedingung verletzt: preis >= 0";
    ...
    public Geldbetrag getPreisFuerPlaetze(Set<Platz> plaetze)
    {
        ...
        int result = _preis.getEuroCent(_preis) * plaetze.size();
        return Geldbetrag.get(result);
    }
